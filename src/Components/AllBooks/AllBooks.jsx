          ...
          : (<div className='row'>
            ...
            {totalCount === 0 && !isLoading ? <div className={styles.notFoundContainer }>
              ...
              <div key={index} className={` col-lg-3 col-sm-6 col-12 mb-5 ${styles.bookCard}`}>
                <BookCard key={book.id} slug={book.slug} image={book.image.secure_url} category={book.category} desc={book.desc} name={book.name} price={book?.price} author={book.author} rate={book.rate} sectionName="Books" />
              </div>
            )) : '')}
