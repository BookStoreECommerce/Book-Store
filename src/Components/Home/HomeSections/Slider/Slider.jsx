            ...
            <div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel" >
                <div className="carousel-inner">
                    ...
                    <div className={styles.carusouelContent}>
                        ...
                        <img src={slide2} className={`d-block w-100 ${styles.sliderImg}`} alt="..." />
                    ...
                    <div className={styles.carusouelContent}>
                        ...
                        <img src={slide3} className={`d-block w-100 ${styles.sliderImg}`} alt="..." />
                    </div>
                    <div className="carousel-item  ">
                    <div className={styles.carusouelContent}>
                        ...
                        <img src={slide4} className={`d-block w-100 ${styles.sliderImg}`} alt="..." />
                    </div>
